<script lang="ts">
    ...
    const handleScroll = () => {
      ...
      if (scrollDelta > 10) {  // Only trigger for significant scroll
        ...
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="hidden md:block">
            <div class="flex items-center space-x-6">
              ...
              >
                মূল পাতা
                <span class="absolute bottom-0 left-0 h-0.5 w-0 bg-amber-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              ...
              >
                ...
                {#if isDropdownOpen}
                  ...
                  >
                    ...
                    <a
                      href="/articles?category=heritage"
                      class="block px-4 py-2 text-gray-700 transition-colors hover:bg-amber-50 hover:text-amber-600"
                    >
                      ঐতিহ্য
                    </a>
