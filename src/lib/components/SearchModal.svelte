					...
					<div class="max-h-[60vh] overflow-y-auto border-t">
						{#if isLoading}
							<div class="p-4 text-center text-gray-500">
								<div
									class="inline-block h-6 w-6 animate-spin rounded-full border-2 border-amber-600 border-t-transparent"
								></div>
								<p class="mt-2">অনুসন্ধান করা হচ্ছে...</p>
							</div>
						{:else if searchResults.length === 0}
							<div class="p-4 text-center text-gray-500">কোন ফলাফল পাওয়া যায়নি</div>
						{:else}
							<div class="divide-y">
